...
const DEFAULT_SKIP_HOOKS = false
...
const (
	...
	AUTHENTICATION_OPTION_OWNER = "owner"
	AUTHENTICATION_OPTION_GROUP = "group"
	AUTHENTICATION_OPTION_PERM  = "perm"
)

var VALID_AUTHENTICATION_OPTIONS = map[AuthenticationMethod]map[string]bool{
	AUTHENTICATION_METHOD_HTTP01_STANDALONE: {
		AUTHENTICATION_OPTION_INTERFACE: true,
		AUTHENTICATION_OPTION_PORT:      true,
	},
	AUTHENTICATION_METHOD_HTTP01_WEBROOT: {
		AUTHENTICATION_OPTION_PATH:  true,
		AUTHENTICATION_OPTION_OWNER: true,
		AUTHENTICATION_OPTION_GROUP: true,
		AUTHENTICATION_OPTION_PERM:  true,
	},
	AUTHENTICATION_METHOD_DNS01_ACMEDNS: {},
}
...
var DEFAULT_AUTHENTICATION_OPTIONS = map[AuthenticationMethod]map[string]string{
	...
	AUTHENTICATION_METHOD_HTTP01_WEBROOT: {
		...
		AUTHENTICATION_OPTION_OWNER: "root",
		AUTHENTICATION_OPTION_GROUP: "root",
		AUTHENTICATION_OPTION_PERM:  "0660",
	},
	AUTHENTICATION_METHOD_DNS01_ACMEDNS: {},
}
